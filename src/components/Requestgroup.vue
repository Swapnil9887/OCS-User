<template>
  ...
  >
    ...
    <custom-alert v-show="!isMemberOfActiveProposals" alertclass="danger" :dismissible="false">
      <p> You must be a member of a currently active proposal in order to create and submit observation requests.</p>
    </custom-alert>
    ...
    <modal :show="showEdPopup" :show-cancel="false" @close="closeEdPopup" @submit="closeEdPopup">
      <h3>Welcome to the observation request page!</h3>
      <p>Using this form you can instruct the telescope network to perform an astronomical observation on your behalf.</p>
      <p>
